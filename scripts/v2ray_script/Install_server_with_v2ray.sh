...
download() {
  ...
  v2ray_url="https://raw.githubusercontent.com/AikoAir-Universe/Air-Universe/master/scripts/proxy-core/xray_speedlimit"
  airuniverse_url="https://github.com/AikoAir-Universe/Air-Universe/releases/download/${VERSION}/Air-Universe-linux-amd64"
  v2ray_json_url="https://raw.githubusercontent.com/AikoAir-Universe/Air-Universe/master/configs/v2ray-core_json/speedLimitTest.json"
  #  start_script_url="https://raw.githubusercontent.com/AikoAir-Universe/Air-Universe/master/scripts/v2ray_script/Start_AU_with_v2ray.sh"
